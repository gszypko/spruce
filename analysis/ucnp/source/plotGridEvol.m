...
gridnames = {'i_n', 'dn', 'e_v_x', 'j_x', 'E_x', 'curlE_z','b_z' };
gridstr = {'i_n', 'dn', 'e_v_x', 'j_x', 'E_x', 'curlE_z','b_z' };
...
fig.Position = [1.303333333333333e+02,2.816666666666666e+02,1148,3.866666666666666e+02];
