...
inp = {'folder';
%             'C:\Users\grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\HIH-0\set_9';
            'C:\Users\grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\HIH-2\set_9';
            'C:\Users\grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\C4.1\set_9';
            'C:\Users\grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\HIH-0\set_11';
            'C:\Users\grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\HIH-2\set_11';
      };
...
flags.sim.ion_holes_2 = false;
flags.sim.hole_orientation = 10;
...
flags.exp.set = 12; % unique set identifier - modifies directory structure as \...\set_XXX
...
for i = 1:length(s)
    ...
    if is_sim_folder
        ...
        if flags.sim.ion_holes_2, ionHolesAnalysis2(data,flags.sim); end
    end
    if is_exp_folder
