...
inp = {'folder';
    'C:\Users\Grant\OneDrive\Research\mhd\data-expsims\an-mhd-09.26.22\HIH-1\set_2';
      };
...
flags.exp.set = 27; % unique set identifier - modifies directory structure as \...\set_XXX
...
flags.exp.n_min = 1e4; % minimum in simulation density distribution cm^-^3
